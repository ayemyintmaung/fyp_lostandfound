...
export const deleteFoundItemAPI = (id) => (dispatch) => {

	const promise = new Promise((resolve, reject) => {
		instance.delete('found/'+id)
			.then((res) => {
				dispatch({type: 'DELETE_FOUND_ITEMS', value: 'Delte Found Item'});
				resolve(res);
			}, (err) => {
				reject(err);
			})
...
export const deleteLostItemAPI = (id) => (dispatch) => {

	const promise = new Promise((resolve, reject) => {
		instance.delete('lost/'+id)
			.then((res) => {
				dispatch({type: 'DELETE_FOUND_ITEMS', value: 'Delte Found Item'});
				resolve(res);
			}, (err) => {
